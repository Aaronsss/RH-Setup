...
#if grep -nq "dtoverlay=gpio-fan,gpiopin=18,temp=48000" /boot/config.txt
#then
#	echo "dtoverlay=gpio-fan,gpiopin=18,temp=48000"
#else
#    sudo -- bash -c 'echo "dtoverlay=gpio-fan,gpiopin=18,temp=48000" >> /boot/config.txt'
#fi
